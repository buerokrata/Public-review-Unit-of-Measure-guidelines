...
Having said that, a design of a good unit of measure should minimise the amount of contextuality involved, and in a datawarehouse the context should be easy to infer, and the units should be applicable to the broadest context of the datawarehouse.

Ratios of commensurable quantities are often presented as _percentage_.This does not provide context at all, it delegates the resposibility of infering comparability and additivity contexts to the user of the data. 
